...
sr.reveal('.sun-before-title',{origin: 'right'},{duration:2000});
sr.reveal('.sun-btn',{origin: 'right'},{duration:2000});
sr.reveal('.mercury-before-title',{origin: 'right'},{duration:2000});
sr.reveal('.mercury-btn',{origin: 'right'},{duration:2000});
sr.reveal('.wenus-before-title',{origin: 'right'},{duration:2000});
sr.reveal('.wenus-btn',{origin: 'right'},{duration:2000});
sr.reveal('.earth-before-title',{origin: 'right'},{duration:2000});
sr.reveal('.earth-btn',{origin: 'right'},{duration:2000});
sr.reveal('.mars-before-title',{origin: 'right'},{duration:2000});
sr.reveal('.mars-btn',{origin: 'right'},{duration:2000});
sr.reveal('.jupiter-before-title',{origin: 'right'},{duration:2000});
sr.reveal('.jupiter-btn',{origin: 'right'},{duration:2000});
sr.reveal('.saturn-before-title',{origin: 'right'},{duration:2000});
sr.reveal('.saturn-btn',{origin: 'right'},{duration:2000});
sr.reveal('.uran-before-title',{origin: 'left'},{duration:2000});
sr.reveal('.uran-btn',{origin: 'left'},{duration:2000});
sr.reveal('.neptun-before-title',{origin: 'right'},{duration:2000});
sr.reveal('.neptun-btn',{origin: 'right'},{duration:2000});
sr.reveal('.pluton-before-title',{origin: 'right'},{duration:2000});
